...
const ExplosionConfetti = (
  {
    isExploding = false,
    amount = 100,
    rate = 1, //be careful with this number. Can freze your app
    radius = 15,
    areaWidth = 3,
    areaHeight = 1,
    fallingHeight = 10,
...
const ExplosionCanvas = () => {
    ...
    // Add a 5 seconds timeout before confetti stop
    setTimeout(() => {
    ...
    return (
        <Canvas>
            <ExplosionConfetti rate={3} fallingHeight={9} amount={50} enableShadows isExploding={isExploding} />
        </Canvas>
    )
}
